...
public class ChatHistoryAdapter extends ArrayAdapter<EMContact> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			Log.i("ChatHistoryAdapter", "02");
		}
		ViewHolder holder = (ViewHolder) convertView.getTag();
		if (holder == null) {
			holder = new ViewHolder();
			holder.name = (TextView) convertView.findViewById(R.id.tv_msg_name);
			holder.unreadLabel = (TextView) convertView.findViewById(R.id.unread_msg_number);
			holder.message = (TextView) convertView.findViewById(R.id.tv_msg_short);
			holder.time = (TextView) convertView.findViewById(R.id.tv_msg_time);
			holder.avatar = (ImageView) convertView.findViewById(R.id.img_msg_head);
		...
		Log.i("ChatHistoryAdapter", "03");
		EMContact user = getItem(position);
		Log.i("ChatHistoryAdapter", user.getUsername());
		Log.i("ChatHistoryAdapter", "04");
