...
public class OthersInfoActivity extends Activity {
	...
	public void initView(){
		...
		View headerview = inflater.inflate(R.layout.headerview_other_info, null);
		ltv_other_info.addHeaderView(headerview, null, true);
		
		datalist = new ArrayList<MineNoteBean>();
		MineNoteBean bean1 = new MineNoteBean(null, "我们被教导要记住思想，而不是人，因为人可能会失败，被杀死或是被遗忘，但是思想不会，不会不会不会不会不会不会", "2015年9月28日", "文青聚集地");
		datalist.add(bean1);
		MineNoteBean bean2 = new MineNoteBean(getResources()
				.getDrawable(R.drawable.pic_test1), "我发誓，我真的活过", "2015年10月9日", "文青聚集地");
		for(int i = 0; i < 4; i++){
			datalist.add(bean2);
		}
