...
public class MainActivity extends FragmentActivity implements OnClickListener{
	...
	private int[] picNors = {
			R.drawable.pic_home_nor,
			R.drawable.pic_find_nor,
			R.drawable.pic_msg_nor,
			R.drawable.pic_mine_nor,
	};
	private int[] picSels = {
			R.drawable.pic_home_sel,
			R.drawable.pic_find_sel,
			R.drawable.pic_msg_sel,
			R.drawable.pic_mine_sel,
	};
	...
	public void switchContent(Fragment from, Fragment to) {
		if (mContent != to) {
			...
			FragmentTransaction transaction = getSupportFragmentManager()
					.beginTransaction();
			if (!to.isAdded()) {
				transaction.hide(from).add(R.id.layout_main_content, to).commit();
			} else {
